<div class="oformlenie">
     	<h1><span id="selection_index1" class="selection_index"></span>[registration]Регистрация нового пользователя[/registration]
	[validation]Обновление профиля пользователя[/validation]</h1><br>
         <div class="baseform">
	...
	<div class="fieldsubmit">
		<button name="submit"class="bbcodes" class="fbutton" type="submit"><span>Отправить</span></button>
	</div>
</div>
</div>                                                              
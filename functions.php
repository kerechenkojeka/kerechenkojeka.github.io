...
$options = array (
	...
	array(	"type" => "open"),
		...
		"desc" => "Введите полный путь до логотипа, либо загрузите свою картинку. Вы можете отредактировать LOGO.psd, который лежит в каталоге темы. <br/>Кликните Загрузить логотип > Переместите или выберите файл > Вставить в запись > Сохранить настройки (прокрутите скроллер до конца страницы)",
		"id" => $shortname."_logo",
...
<?php 
        ...
        <tr>
			...
			<input id="upload_image_button" type="button" class="button" value="Закачать логотип" /><br/> 
...
<p class="submit">
<input name="save" type="submit" class="button button-primary" value="Сохранить" />    
...
<span style="padding-top:0px;float:left; width:200px;"><a style="float:left; font-weight:bold; width:200px; padding-top:5px;" title="<?php the_title(); ?>" href="<?php the_permalink(); ?>"><?php the_title(); ?></a><br/>

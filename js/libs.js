...
$(document).ready(function(){
	...
	$('.mplayer-scroll').click(function(){
		$('html, body').animate({ scrollTop : $('.mplayer').offset().top }, 'slow');
	});
	...
	$('.tabs-sel').on('click', 'span:not(.current)', function() {
		...
		.parents('.tabs-box').find('.tabs-b').hide().removeClass('visible').eq($(this).index()).fadeIn(0).addClass('visible');
	});

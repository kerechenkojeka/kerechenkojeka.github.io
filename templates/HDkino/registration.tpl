<div class="page-site"><div class="basecont">
	<div class="dpad">
		<h2 class="heading"><span id="news-title">[registration]Регистрация нового пользователя[/registration]
	[validation]Обновление профиля пользователя[/validation]</span></h2>
